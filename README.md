...
**синтаксис:**
**for**{firstExpression; conditionExpression, eachStepExpression; doExpression}
, где
**firstExpression** - выражение выполняющееся первым
**conditionExpression** - логическое выражение, пока оно возвращает true - цикл не завершается
**eachStepExpression** - выражение выполняющееся каждый шаг
**doExpression** - выражение, которое необходимо многократно повторить
