...
--- | --- | --- | --- | ---
array | int или string (ключ) | произвольный тип (значение) | null | $list = array(1, 2, 3);<br>setArrayValue($list, 2, 5); <br>// 3ий элемент массива будет созержать значение 5

### setArrayValue - установка значения массива по ключу
**Пример** | **Результат**
--- | ---
$list = array(1, 2, 3);<br>setArrayValue(2); | переменная $result будет содержать 3ий элемент массива
